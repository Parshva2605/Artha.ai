...
Generate labeled datasets (sentiment, intent, toxicity) in Hindi, Gujarati, Tamil, Marathi, and more - ready for ML training in minutes.
...
OPENROUTER_APP_NAME=BhashaData
REDDIT_CLIENT_ID=...
