            ...
            <div className="mt-4 space-y-6">
              ...
              <div>
                <label className="inline-flex items-center gap-2">
                  <input
                    type="checkbox"
                    checked={!!form.use_synthetic}
                    onChange={(e) => setForm((previous) => ({ ...previous, use_synthetic: e.target.checked }))}
                    className="h-4 w-4 accent-[#E8690A]"
                  />
                  <span className="text-sm text-slate-700">Use synthetic data if scraping yields too few rows</span>
                </label>
              </div>
            </div>
          </section>
